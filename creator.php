...
<?php 
	...
	/*
		Post generated string with the paramters  from the login page
		
		resellerID=3
		&name=Enrico Miglino
		&full_name=Tech Consulting - Ibiza,Spain
		&email=enrico.miglino@ovi.com
		&reseller_code=MGLN-RC61-C10L-219I
...
<link href="LicenseCreator.css" rel="stylesheet" type="text/css" />
</head>

<body>
  <div class="header">License Creator</div>
  <div class="content">
    ...
    <p>
      ...
      <p>
        ...
        <input name="quantity" class="form_field" type="text" id="quantity" tabindex="12" value="1" size="3" maxlength="3">
    </p>
      <p>
        <label class="form_text" for="expire">Duration (number of days)</label>
        <input name="expire" class="form_field" type="text" id="expire" tabindex="13" size="3" maxlength="3">
      </p>
